...
public class Template012WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template012WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template012WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template012WLAIW/InitOutcome.xml").getDocumentElement();
